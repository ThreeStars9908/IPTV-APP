...
public class VideoExampleWithExoPlayerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String str_video_title = getIntent().getStringExtra("video_title");
        String str_video_url = getIntent().getStringExtra("video_path");
        FragmentTransaction ft = getFragmentManager().beginTransaction();


        Bundle bundle = new Bundle();
        bundle.putString("video_title", str_video_title);
        bundle.putString("video_path", str_video_url);
        VideoConsumptionExampleWithExoPlayerFragment fgmt = new VideoConsumptionExampleWithExoPlayerFragment();
        fgmt.setArguments(bundle);
        ft.replace(R.id.videoFragment, fgmt);
        ft.commit();
    }
